...
// import { LayoutDashboard, Key, Zap, Palette, MessageSquare, BarChart2, Settings, LogOut, Bot, X, Brain, Mic } from "lucide-react";
// import { useAuth } from "../context/AuthContext";
// import { logout } from "../api/authService";

// const links = [
//   { to: "/dashboard",     icon: <LayoutDashboard size={17} />, label: "Dashboard"     },
//   { to: "/train-bot",     icon: <Brain size={17} />,           label: "Train Bot"     },
...
//               <div className="text-slate-900 dark:text-slate-200 text-sm font-medium leading-none truncate">
//                 {firstName}
//               </div>
...
//           <button
//             onClick={logout}
//             className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm text-slate-600 dark:text-slate-400 hover:bg-red-50 dark:hover:bg-red-500/10 hover:text-red-600 dark:hover:text-red-400"
//           >
//             <LogOut size={17} />
//             <span>Logout</span>
//           </button>
...
const links = [
  ...
  { to: "/customization", icon: <Palette size={17} />,         label: "Customization" },
  { to: "/chat-logs",     icon: <MessageSquare size={17} />,   label: "Chat Logs"     },
  { to: "/voice-chat",    icon: <Mic size={17} />,             label: "Voice Chat"    },
  { to: "/analytics",     icon: <BarChart2 size={17} />,       label: "Analytics"     },
  { to: "/settings",      icon: <Settings size={17} />,        label: "Settings"      },
  { to: "/plans",         icon: <Zap size={17} />,             label: "Plans"         },
];
