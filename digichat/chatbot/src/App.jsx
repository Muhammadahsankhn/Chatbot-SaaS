...
//       <div style={{ opacity: preloaderDone ? 1 : 0, transition: "opacity 0.4s ease", width: "100%", overflowX: "hidden" }}>
//         <AuthProvider>
//           <BrowserRouter>
...
//               <Route path="/search" element={<Navigate to="/chat-logs" replace />} />
        ...
        <AuthProvider>
          <BrowserRouter>
            ...
            <Routes>
              ...
              <Route path="/settings" element={<ProtectedLayout><Settings /></ProtectedLayout>} />
              <Route path="/plans" element={<ProtectedLayout><Plans /></ProtectedLayout>} />
              <Route path="/voice-chat" element={<ProtectedLayout><VoiceChat /></ProtectedLayout>} />
              <Route path="/search" element={<Navigate to="/chat-logs" replace />} />
              <Route path="*" element={<Navigate to="/dashboard" replace />} />
            </Routes>
          </BrowserRouter>
