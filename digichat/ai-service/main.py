...
ALLOWED_ORIGINS = os.getenv("ALLOWED_ORIGINS", "https://www.digicareproducts.com,https://digichat.digixworkspace.com")
NODE_ENV        = os.getenv("NODE_ENV", "development")
FRONTEND_BUILD  = os.getenv("FRONTEND_BUILD", "../public")
...
if os.path.exists(DIST_PATH):
    ...
    async def serve_react(full_path: str):
        # We don't want to catch API routes or docs by accident if they fail,
        # but FastAPI handles defined routes first.
